...
```bash
py-sql-testing$ sam build --use-container
```
...
```bash
py-sql-testing$ sam logs -n HelloWorldFunction --stack-name "py-sql-testing" --tail
```
...
```bash
py-sql-testing$ pip install -r tests/requirements.txt --user
# unit test
py-sql-testing$ python -m pytest tests/unit -v
# integration test, requiring deploying the stack first.
# Create the env variable AWS_SAM_STACK_NAME with the name of the stack we are testing
py-sql-testing$ AWS_SAM_STACK_NAME="py-sql-testing" python -m pytest tests/integration -v
```
...
```bash
sam delete --stack-name "py-sql-testing"
```
